package com.chris.a13_apiaccess
...
import com.marvin.a13_apiaccess.api.cls_Notas
import com.marvin.a13_apiaccess.api.cls_UsoApi
...
class MainActivity : AppCompatActivity() {
    ...
    private fun doLoadTasks(): Array<cls_Notas?>? {
        val TAG = "Uso de API"
        var tareas: Array<cls_Notas?>? = null
        myExecutor.execute {
            try {
