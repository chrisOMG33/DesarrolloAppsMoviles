package com.chris.a13_apiaccess.api
...
class cls_UsoApi {
    ...
    private val urlPath = "http://10.236.2.142:5000/"
    ...
    fun addtask(tarea: String?, token: String): cls_Notas? {
        var registro: cls_Notas? = null
    ...
    fun gettask(token: String?): Array<cls_Notas?>? {
        ...
        try {
            if (conex!!.responseCode == HttpURLConnection.HTTP_OK) {
                ...
                var registro =  arrayOfNulls<cls_Notas?>((auxGen["data"] as JSONArray).length())
